...
export default function AdminProfile() {
  ...
  const initials = form.fullName.trim().split(' ').map(p => p[0]).join('').toUpperCase().slice(0, 2) || 'AD';
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem', maxWidth: 860 }}>
          ...
          <div className="mv-card animate-fade-up" style={{ textAlign: 'center', padding: '2rem 1.5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 8, flexWrap: 'wrap', marginBottom: '1.25rem' }}>
              <span className="mv-badge mv-badge-purple"><Shield size={11} /> Admin</span>
          ...
          <div className="mv-card animate-fade-up" style={{ animationDelay: '100ms' }}>
            <div className="mv-card-header">
              ...
              {!editing && (
                <span className="mv-badge mv-badge-gray" style={{ fontSize: '0.72rem' }}>Read-only</span>
              )}
            </div>
                ...
                <div className="mv-form-group">
                  ...
                  <div className="mv-input-wrap">
                    ...
                    <input id="fullName" name="fullName" type="text" value={form.fullName}
                      ...
                      disabled={!editing} className="mv-input" />
                  </div>
                </div>
                ...
                <div className="mv-form-group">
                  ...
                  <div className="mv-input-wrap">
                    ...
                    <input id="email" name="email" type="email" value={form.email}
                      ...
                      disabled={!editing} className={`mv-input${errors.email ? ' error' : ''}`} />
                  </div>
                ...
                {editing && (
                  <>
                    ...
                    <div className="mv-form-group">
                      ...
                      <div className="mv-input-wrap">
                        ...
                        <input id="newPassword" name="newPassword"
                          type={showNew ? 'text' : 'password'} value={form.newPassword}
                    ...
                    <div className="mv-form-group">
                      ...
                      <div className="mv-input-wrap">
                        ...
                        <input id="confirmPassword" name="confirmPassword"
                          type={showCon ? 'text' : 'password'} value={form.confirmPassword}
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
                      <button type="submit"
                        className={`mv-btn mv-btn-primary ${saving ? 'mv-btn-loading' : ''}`}
                        disabled={saving} style={{ flex: 1, minWidth: 120 }}>
                        {saving ? <><span className="mv-spinner" /><span>Saving…</span></> : 'Save Changes'}
                      </button>
                      <button type="button" onClick={() => setEditing(false)}
                        className="mv-btn mv-btn-ghost" style={{ flex: 1, minWidth: 100 }}>
                        Cancel
                      </button>
                    </div>
                  </>
